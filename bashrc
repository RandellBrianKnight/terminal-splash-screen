...
# UPDT: 2019-05-24 If Weather unavailable it displays a nicely formatted error message.
...
curl wttr.in/Houma?0 --silent --max-time 3 > /tmp/now-weather
...
if [[ "${aWeather[0]}" == "Weather report:"* ]] ; then
    ...
    echo "|                            |"
    echo "| curl wttr.in/Houma?0       |" # Replace Houma with your city
